...
func TestTransition(t *testing.T) {
	tests := []struct {
		...
		{name: "new to assigned", current: StateNew, target: StateAssigned, want: StateAssigned},
		...
		{name: "invalid current", current: State("blocked"), target: StateReview, wantErr: "invalid current workflow state"},
		{name: "invalid target", current: StateReview, target: State("blocked"), wantErr: "invalid target workflow state"},
	}
